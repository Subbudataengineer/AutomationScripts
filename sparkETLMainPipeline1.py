'''
Code:
Standardize - main method, arguments, checking arguments, seperating functions and calling
...
'''
#Packaging, Ship, Deployment & Execution of the code
#import shutil
#shutil.make_archive("/home/hduser/wd32package/wd32project","zip", root_dir="/home/hduser/PycharmProjects/wd32project/")
...
#mid priority --> Spark Jar location (/usr/local/spark/jars/)
...
if __name__=="__main__":#If this prog is just imported by someone, then don't run it.. if someone called the main method then u run it
    if(len(sys.argv)==4):#module.py file:///home/hduser/hive/data/custsmodified file:///home/hduser/hive/data/txns /home/hduser/connection.prop
        from pyspark.sql import SparkSession
        from pyspark.sql.functions import *
        from pyspark.sql.types import *
        from pyspark.sql.window import *
        from learn.izpyspark.sql.reusable_functions import *
